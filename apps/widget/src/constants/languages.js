...
export const ALL_LANGUAGE_OPTIONS = [...PRIMARY_LANGUAGE_OPTIONS, ...EXTRA_LANGUAGE_OPTIONS];
export const languageLabelFromTag = (tag) => ALL_LANGUAGE_OPTIONS.find((option) => option.tag.toLowerCase() === tag.toLowerCase())?.label ?? tag;
