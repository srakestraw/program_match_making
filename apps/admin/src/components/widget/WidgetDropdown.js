...
export function WidgetDropdown() {
    ...
    return (_jsxs("div", { className: "relative", ref: ref, children: [_jsx("button", { type: "button", className: navLinkClass, onClick: () => setOpen((prev) => !prev), "aria-expanded": open, "aria-haspopup": "true", children: "Widget" }), open && (_jsxs("div", { className: "absolute right-0 top-full z-20 mt-1 min-w-[11rem] rounded-md border border-slate-200 bg-white py-1 shadow-lg", role: "menu", children: [_jsx(Link, { className: "block px-3 py-2 text-sm text-slate-700 hover:bg-slate-100", to: "/widget/branding", role: "menuitem", children: "Branding" }), _jsx(Link, { className: "block px-3 py-2 text-sm text-slate-700 hover:bg-slate-100", to: "/widget/embed", role: "menuitem", children: "Embed Widget" }), _jsx(Link, { className: "block px-3 py-2 text-sm text-slate-700 hover:bg-slate-100", to: "/widget/preview", role: "menuitem", children: "Candidate Preview" }), _jsx(Link, { className: "block px-3 py-2 text-sm text-slate-700 hover:bg-slate-100", to: "/widget/orchestration", role: "menuitem", children: "Orchestration" })] }))] }));
}
